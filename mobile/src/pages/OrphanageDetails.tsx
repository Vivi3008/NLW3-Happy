...
interface OrphanageParamId {
  id: number
}

interface ShimmerState {
  visible: boolean,
  userImageVisible: boolean,
  postImageVisible: boolean,
}

export default function OrphanageDetails() {
  const routes = useRoute() //resgata o valor passado no parametro
  const [ orphanage, setOrphanage ] = useState<OrphanageDetail>()

  const params = routes.params as OrphanageParamId

  const [ shimmer, setShimmer] = useState<ShimmerState>({
    visible: true,
    userImageVisible: true,
    postImageVisible: true,
  })
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.scheduleContainer}>
            <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
              ...
              <Text style={[styles.scheduleText, styles.scheduleTextBlue]}></Text>
            </View>
            <View style={[styles.scheduleItem, styles.scheduleItemGreen]}>
              
              <Text style={[styles.scheduleText, styles.scheduleTextGreen]}></Text>
            </View>
          </View>
